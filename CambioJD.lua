-- ===== SCRIPT DE INTERCAMBIO DE POSICIONES CORREGIDO =====
...
-- FUNCIÓN CORREGIDA PARA INTERCAMBIO DE POSICIONES
local function swapPositions(targetPlayer)
    ...
    if myCharacter and targetCharacter and 
       ...
       targetCharacter:FindFirstChild("HumanoidRootPart") then
        ...
        -- INTERCAMBIO CORREGIDO - Método confiable
        -- Paso 1: Moverme a posición temporal arriba del objetivo
        myCharacter.HumanoidRootPart.CFrame = targetPosition + Vector3.new(0, 5, 0)
        wait(0.1)
        
        -- Paso 2: Mover al objetivo a posición temporal arriba de mi posición original
        targetCharacter.HumanoidRootPart.CFrame = myPosition + Vector3.new(0, 5, 0)
        wait(0.1)
        
        -- Paso 3: Intercambio final
        myCharacter.HumanoidRootPart.CFrame = targetPosition
        targetCharacter.HumanoidRootPart.CFrame = myPosition
        
        game.StarterGui:SetCore("ChatMakeSystemMessage", {
            Text = "[SWAP] ✅ Intercambio exitoso con " .. targetPlayer.DisplayName;
        ...
        game.StarterGui:SetCore("ChatMakeSystemMessage", {
            Text = "[SWAP] ❌ Error: Personaje no disponible";
            Color = Color3.new(1, 0.3, 0.3);
            Font = Enum.Font.GothamBold;
            FontSize = Enum.FontSize.Size18;
        })
...
local function createGUI()
    ...
    minimizeButton.MouseButton1Click:Connect(function()
        ...
        if isGuiVisible then
            ...
            mainFrame.Position = UDim2.new(0, 10, 0.5, -22.5)
            for _, child in pairs(mainFrame:GetChildren()) do
                if child.Name ~= "TitleLabel" and child.Name ~= "UICorner" and child.Name ~= "UIStroke" then
                    child.Visible = false
                end
            end
            minimizeButton.Text = "+"
...
print("✅ Script de intercambio de posiciones cargado correctamente!")
print("📝 Presiona INSERT para mostrar/ocultar la interfaz")
print("🔄 El intercambio ahora funciona correctamente")
